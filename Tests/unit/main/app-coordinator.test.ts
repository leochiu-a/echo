...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    slashCommands: [{ id: '321e4567-e89b-42d3-a456-426614174000', command: 'reply', prompt: 'Draft {{input}}' }],
...
describe('AppCoordinator', () => {
  ...
  it('records succeeded history entry for completed runtime result with exit code 0', async () => {
    ...
    expect(send).toHaveBeenCalledWith(ipcChannels.runtimeEvent, { type: 'delta', delta: 'stream chunk' })
  })
