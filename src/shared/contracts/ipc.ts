...
export interface EchoRendererApi {
  settings: {
    ...
    update: (partial: Partial<z.infer<typeof appSettingsSchema>>) => Promise<z.infer<typeof appSettingsSchema>>
  ...
  overlay: {
    ...
    onContextReady: (listener: (context: z.infer<typeof overlayContextSchema>) => void) => () => void
  }
  runtime: {
