...
export const retentionMaxAgeByPolicy: Record<Exclude<PromptHistoryRetentionPolicy, 'forever'>, number> = {
...
export function applyRetention(entries: PromptHistoryEntry[], policy: PromptHistoryRetentionPolicy): PromptHistoryEntry[] {
  if (policy === 'forever') {
    return entries
  }
